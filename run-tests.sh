...
FORTH="wordlist labels doloop debug ls require open accept help asm turnkey \
...
# Test-suite files.
TESTS="tester testcore testcoreplus testcoreext testexception testx16 testvideo testsprite testtile testpalfx testinput testcoreadd testaudio testbank testvramdisk testloadsave testgraphic testromdisk testfloat testfile teststring testsystem testextras test 1"
